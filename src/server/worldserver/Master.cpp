...
int Master::Run()
{
    ...
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "OpenCataclysm XII 2014");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "Visit us online: wow.boi-infinity.com");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "OpenCataclysm XII 4.3.4");
